  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-2xl">
        <h2 className="text-[#1B374D] text-6xl font-normal mb-3 text-left ">Login </h2>
        <h3 className="text-[#1B374D] text-base font-medium mb-4 mx-3 capitalize text-left"> Please Sign in to Continue </h3>
        ...
        <div className="text-center mt-4">
          <span className="text-[#1B374D]">Don't have an account ? </span>
          <a href="/register" className="text-[#1B374D] underline font-semibold ">
            Sign Up
          </a>
        </div>
      </div>
